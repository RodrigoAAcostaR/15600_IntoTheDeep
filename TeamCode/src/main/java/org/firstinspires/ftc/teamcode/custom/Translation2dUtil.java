...
public class Translation2dUtil extends Translation2d {
     ...
     */
    public Translation2dUtil(double x, double y) {
        m_x = x;
        m_y = y;
    }
     ...
     */
    public Translation2dUtil(double distance, Rotation2dUtil angle) {
     ...
     */
    public double getDistance(Translation2dUtil other) {
     ...
     */
    public Translation2dUtil rotateBy(Rotation2dUtil other) {
        return new Translation2dUtil(
     ...
     */
    public Translation2dUtil plus(Translation2dUtil other) {
        return new Translation2dUtil(m_x + other.m_x, m_y + other.m_y);
    }
     ...
     */
    public Translation2dUtil minus(Translation2dUtil other) {
        return new Translation2dUtil(m_x - other.m_x, m_y - other.m_y);
    }
     ...
     */
    public Translation2dUtil unaryMinus() {
        return new Translation2dUtil(-m_x, -m_y);
    }
     ...
     */
    public Translation2dUtil times(double scalar) {
        return new Translation2dUtil(m_x * scalar, m_y * scalar);
    }
     ...
     */
    public Translation2dUtil div(double scalar) {
        return new Translation2dUtil(m_x / scalar, m_y / scalar);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Translation2dUtil) {
            return Math.abs(((Translation2dUtil) obj).m_x - m_x) < 1E-9
                    && Math.abs(((Translation2dUtil) obj).m_y - m_y) < 1E-9;
        }
        return false;
    }
